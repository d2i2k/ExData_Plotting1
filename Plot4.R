...
datetime <- strptime(dates_times, "%d/%m/%Y %I:%M:%S %p")
par(mfrow=c(2,2))
plot(x,energyData$Global_active_power,type="l",ylab="Global Active Power",xlab=" ")
plot(x,energyData$Voltage,type="l",ylab="Voltage",xlab="datetime")
...
plot(x,energyData$Global_reactive_power,type="l",ylab="Global_reactive_power",xlab="datetime")